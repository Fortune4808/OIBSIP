...
$documentStoragePath = "http://localhost/OIBSIP/task4/api/uploaded-files/picture/"; //desktop view
// $documentStoragePath = "http://10.191.234.35/OIBSIP/task4/api/uploaded-files/picture/"; //mobile view
