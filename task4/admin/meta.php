<link rel="icon" type="image/png" href="<?php echo $websiteUrl; ?>/public/all-images/logo-pix/favicon.png">

<link rel="stylesheet" href="<?php echo $websiteUrl; ?>/admin/style/main.css?v=<?php echo $codeVersion; ?>">
...
<script src="<?php echo $websiteUrl; ?>/admin/js/script.js?v=<?php echo $codeVersion; ?>" defer></script>
